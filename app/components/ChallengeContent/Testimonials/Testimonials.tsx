    ...
    <section className="section-padding relative overflow-x-hidden">
      <div className="container flex flex-col gap-10">
        ...
        <div className="mx-auto max-w-4xl space-y-3 lg:space-y-4 lg:text-center">
          <h2 className="text-4xl tracking-tight lg:text-5xl text-center text-white">
            {content.feedback_block.title}
          </h2>
          <p className="text-white/60 text-lg leading-snug lg:text-balance text-center">
        ...
        <div className="p-6 sm:p-8 md:p-[36px_95px] mt-8 md:mt-15 m-auto flex flex-col sm:flex-row items-center gap-6 sm:gap-8 md:gap-15 rounded-2xl md:rounded-3xl max-w-[960px] bg-white/10 backdrop-blur-xl border border-white/20">
