...
const trophyColors = { 1: "#CD7F32", 2: "#C0C0C0", 3: "#FFD700" };

const getColor = (rating: number) => trophyColors[rating as 1 | 2 | 3];

const Trophy = ({ title, rating }: ITrophyProps) => {
  const trophyColor = getColor(rating);

  return (
    <div className="w-full h-20 rounded-sm bg-white p-2 border border-neutral-300">
