  ...
  return (
    <section className="flex flex-col items-center px-4 pt-12 pb-4 relative max-w-4xl mx-auto">
      ...
      <motion.div
        ...
        className="mt-6 relative z-10 rounded-2xl bg-white/10 backdrop-blur-md border border-white/20 shadow-lg px-2 sm:px-3 py-2 sm:py-2.5 w-[calc(100vw-2rem)] sm:max-w-[95vw] mx-auto"
      >
