    ...
    <div className="p-8 font-sans max-w-4xl mx-auto">
      ...
      <div className="mb-8">
        ...
        <div className="ml-4">
          ...
          <p className="mb-3">
            You can link MyFinishLine with any supported data provider available
            in the app (e.g., Strava, Garmin, Fitbit, Apple Health, etc.).
          </p>
          <p className="mb-3">
            We receive only data you explicitly authorize the provider to share,
            such as:
          </p>
          <ul className="list-disc pl-8 mb-4 space-y-2">
          ...
          <p className="mb-4 italic">
            If location or route data is provided, we use only what is necessary
            for service delivery and do not retain precise private locations. We
            comply with provider terms including Strava API requirements.
          </p>
      ...
      <div className="mb-8">
        ...
        <ul className="list-disc pl-8 mb-4 space-y-2">
          ...
          <li>communicate with you (support, updates, account changes);</li>
        ...
        <p className="mb-4">
          ...
          explicit consent. We do not use automated profiling to make decisions
          about you.
        </p>
      </div>
      ...
      <div className="mb-8">
        ...
        <ul className="list-disc pl-8 mb-4 space-y-2">
          <li>
            Service providers (hosting, analytics, email delivery) acting on our
            behalf under confidentiality;
          </li>
      ...
      <div className="mb-8">
        ...
        <p className="mb-4">
          If a minor uses MyFinishLine with consent, privacy settings default to
      ...
      <div className="mb-8">
        ...
        <p className="mb-4">
          We may store and process your data on secure cloud servers. These may
          be located in one or more countries to support global operations. We
          implement technical and organizational safeguards to protect your
      ...
      <div className="mb-8">
        ...
        <ul className="list-disc pl-8 mb-4 space-y-2">
          ...
          <li>
            as required by law or business needs (e.g., tax, legal compliance).
          </li>
        </ul>
        <p className="mb-4">
      ...
      <div className="mb-8">
        ...
        <ul className="list-disc pl-8 mb-4 space-y-2">
          ...
          <li>
            <span className="font-semibold">Deletion:</span> request deletion of
      ...
      <div className="mb-8">
        <h2 className="text-2xl font-bold text-black mb-4">10. Security</h2>
        <p className="mb-4">
      ...
      <div className="border-t-2 border-gray-300 pt-6 mt-8 text-center text-gray-500 text-sm">
        <p>MyFinishLine Privacy Policy</p>
      </div>
    </div>
  );
};
